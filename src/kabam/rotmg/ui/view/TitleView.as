...
public class TitleView extends Sprite
{
	...
	{
		var _local_1:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(12).setColor(0x1BDA18);
    ...
    private function updateVersionText():void{
        this.versionText.setStringBuilder(new StaticStringBuilder("Playinlike "
                +this.data.buildLabel));
    }
